...
# CODUL TĂU VINE MAI JOS:
text='Astazi avem o zi foarte \n productiva. Am programat în Python \nCircuite Playgroud Circuit  \n si drone!'
print(text)
# CODUL TĂU VINE MAI SUS:
...
name = "Toma"
name2 = "Vitalina"
f_string = f"Numele meu este {name} și prenumele meu este {name2}!."
print(f_string)
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
format_string = "Numele meu este {} și prenumele meu este {}.".format(name, name2)
print(format_string)
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
print(text+"  "+format_string)
# CODUL TĂU VINE MAI SUS:

# Afișează lungimea string-ului creat

# CODUL TĂU VINE MAI JOS:
print(len(text+"  "+format_string))
# CODUL TĂU VINE MAI SUS:
